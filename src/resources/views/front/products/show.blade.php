				...
				<div class="pro-detail-infor list-item">
					<div class="col-md-4 col-sm-4 col-xs-12">
						...
						<div class="more-img">
							...
							@endif
							@if($key < 4) @if($key===1) <img class="lazyload sub-img img1" data-src="{{asset('/storage')}}/{{$media->source}}" alt="product">
								@else
			...
			<div class="bg-sidebar">
				...
				<div class="categories">
					...
					<ul>
						...
						<li>
							<a href="{{url('/subject')}}/{{$product_category->slug}}/{{$category->slug}}" title="">{{$category->translation->name}}</a>
							<small>
				...
				<div class="searchbytag">
					...
					<ul class="tags">
						@foreach($tags as $tag)
						<li><a href="{{url('/subject/products/tags')}}/{{$tag->slug}}">{{$tag->name}}</a></li>
						@endforeach
					</ul>
				</div>
			</div>
...
<script defer type="text/javascript" src="{{ asset('js/flytocart.js') }}"></script>
