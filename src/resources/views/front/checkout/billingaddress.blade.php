				...
				<div class="card-deck card-cols-sm-1 card-cols-md-2 card-cols-lg-3 address-list">
						<div class="card card-block address-list-item">
							<div class="address-item">
								<button class="btn btn-warning btn-block select-billing-address-button" onclick="setLocation('/frontend/en/Checkout/SelectBillingAddress?addressId=12896')">
...
<form action="/frontend/en/Checkout/BillingAddress" method="post" novalidate="novalidate">					<div class="enter-address-body">
