...
@section('title','Thông Tin Tài Khoản - Cà Phê Đăk Hà')
                            ...
                            <div class="col-md-8 col-lg-9">
                                ...
                                {{ csrf_field() }}
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group row"><label class="col-lg-3 col-form-label required" for="FirstName" aria-required="true">First name</label>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="form-group row"><label class="col-lg-3 col-form-label required" for="LastName" aria-required="true">Last name</label>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="form-group row"><label class="col-lg-3 col-form-label required" for="Email" aria-required="true">Email</label>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="form-group row"><label class="col-lg-3 col-form-label" for="Phone" aria-required="true">Phone</label>
                                            <div class="col-lg-9">
                                    ...
                                    <fieldset class="content-group">
                                        ...
                                        <div class="form-group row"><label class="col-lg-3 col-form-label" for="Company">Company Name</label>
                                            <div class="col-lg-9">
