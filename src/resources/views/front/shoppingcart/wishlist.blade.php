                                            ...
                                            <div id="{{$row->rowId}}" class="cart-row">
                                                ...
                                                <div class="cart-col cart-col-qty" data-caption="Quantity">
                                                    <div class="qty-input">
                                                        ...
                                                        <input class="form-control" data-href="/Cart/UpdateWishlistItem?ItemId={{$row->rowId}}" data-max="10000" data-min="1" data-postfix="" data-sci-item="{{$row->rowId}}" data-step="1" data-val="true" data-val-number="The field 'EnteredQuantity' must be a number." id="itemquantity{{$row->id}}" type="text" value="{{$row->qty}}" style="display: block;">
