        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img data-src="{{asset('images/logo/poko.png')}}" class="lazyload user-image" alt="User Image">
                <span class="hidden-xs">{{Auth::user()->last_name}} {{Auth::user()->first_name}}</span>
              </a>
              <ul class="dropdown-menu">
                <!-- User image -->
                <li class="user-header">
                  <img data-src="{{asset('images/logo/poko.png')}}" class="lazyload img-circle" alt="User Image">
