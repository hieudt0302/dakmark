        ...
        <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
                <div class="ft-contact">
                    ...
                    <div class="ct-icon">
                        <a target="_blank" href="http://www.facebook.com/{{ Setting::config('facebook') }}"><i class="fa fa-facebook" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="Facebook"></i></a>
            ...
            <div class="col-md-3 col-sm-3 col-xs-12">
                <div class="ft-photo">
                    ...
                    <div class="photo-it">
                        ...
                        <div class="img-ft-2">
                            <a href="#"><img class="lazyload img-ft-2" data-src="{{asset('/images/logo/tdc-logo.png')}}" alt="TDC Logo"></a>
                        </div>
                    </div>
                </div>
                <br>
