                        ...
                        <div class="tab-pane fade" id="{{$language->id}}-content">  
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">Tên</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="{{$language->id}}-name" class="form-control" id="name" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="summary" class="col-sm-2 control-label">Mô Tả</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="{{$language->id}}-summary" rows="3"  placeholder="summary"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="description" class="col-sm-2 control-label">Giới Thiệu</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="{{$language->id}}-description" rows="3"  placeholder="description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="specs" class="col-sm-2 control-label">Đặc Tả</label>
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="{{$language->id}}-specs" rows="3"  placeholder="specs"></textarea>
                                    </div>
                                </div>                               
                            </div>
