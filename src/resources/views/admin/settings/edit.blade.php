                        ...
                        <div class="tab-pane active" id="company">
                            <table class="table table-responsive">
                              <tr>
                                  <td>Copyright 1</td>
                                  <td>
                                      <input type="text" class="form-control" name="copyright1" value="{{ Setting::config('copyright1') }}"/>
                                  </td>
                              </tr>
                              <tr>
                                  <td>Copyright 2</td>
                                  <td>
                                      <input type="text" class="form-control" name="copyright2" value="{{ Setting::config('copyright2') }}"/>
                                  </td>
                              </tr>
                              <tr>
                                  <td>Địa Chỉ</td>
