                   ...
                   <input name="_method" type="hidden" value="PATCH">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea id="excerpt-editor" name="excerpt" rows="10" cols="80">{!!$post->excerpt!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="slug" class="col-sm-12">Nội Dung</label>
                            <div class="col-sm-12">
                                <textarea id="content-editor" name="content" rows="10" cols="80">{!!$post->content!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="description" class="col-sm-2 control-label">Giới Thiệu</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" rows="3"  placeholder="SEO">{{$post->description}}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
