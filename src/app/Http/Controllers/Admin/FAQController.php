...
class FaqController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        if(!empty( $language_id) &&   $language_id  > 0 ){
            $translation =FaqTranslation::where('faq_id',$id)->where('language_id', $language_id)->withoutGlobalScopes()->firstOrFail();
            $tab= 2;
        }        
        return View('admin.faqs.edit',compact('faq','languages','translation','tab'));               
    }
    ...
    {
        $translation = FaqTranslation::where('language_id',$code)
        ->where('faq_id',$id)->withoutGlobalScopes()
        ->first();
